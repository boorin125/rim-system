...
export default function IncidentTimeline({ incidentId }: IncidentTimelineProps) {
  ...
  const getActionColor = (action: string) => {
    const colors: any = {
      ...
      UNASSIGNED: 'text-gray-400 bg-gray-900/20 border-gray-700/50',
      REASSIGNED: 'text-orange-400 bg-orange-900/20 border-orange-700/50',
      REQUESTED_ONSITE: 'text-violet-400 bg-violet-900/20 border-violet-700/50',
      TECHNICIAN_RESPONDED: 'text-sky-400 bg-sky-900/20 border-sky-700/50',
      ...
      CLOSE_REJECTED: 'text-red-400 bg-red-900/20 border-red-700/50',
      CLOSED: 'text-slate-400 bg-slate-900/20 border-slate-700/50',
      DIRECT_CLOSED: 'text-slate-400 bg-slate-900/20 border-slate-700/50',
      REOPENED: 'text-amber-400 bg-amber-900/20 border-amber-700/50',
      RETURN_JOB_CREATED: 'text-purple-400 bg-purple-900/20 border-purple-700/50',
  ...
  const formatAction = (action: string) => {
    const labels: any = {
      CREATED: 'สร้าง Incident',
      UPDATED: 'อัปเดต',
      STATUS_CHANGED: 'เปลี่ยนสถานะ',
      ASSIGNED: 'มอบหมายงาน',
      UNASSIGNED: 'ยกเลิกการมอบหมาย',
      REASSIGNED: 'เปลี่ยน Technician',
      REQUESTED_ONSITE: 'ขอ Onsite',
      TECHNICIAN_RESPONDED: 'Tech รับทราบ',
      CHECKED_IN: 'Check-in',
      RESOLVED: 'ส่งงานแก้ไขแล้ว',
      RESOLUTION_UPDATED: 'แก้ไขสรุปงาน',
      TECH_CONFIRMED: 'Tech ยืนยันปิดงาน',
      CONFIRMED: 'Confirm & Close',
      CLOSE_REJECTED: 'ปฏิเสธการปิดงาน',
      CLOSED: 'ปิดงาน',
      DIRECT_CLOSED: 'ปิดงานโดยตรง',
      REOPENED: 'เปิดงานใหม่',
      RETURN_JOB_CREATED: 'สร้างงาน Return',
      CANCELLED: 'ยกเลิก',

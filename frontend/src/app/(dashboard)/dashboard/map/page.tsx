...
const statusFilters = [
  ...
  { value: 'RESOLVED', label: 'แก้ไขแล้ว', color: 'bg-yellow-500' },
...
const statusBadge: Record<string, { label: string; cls: string }> = {
  ...
  RESOLVED:    { label: 'แก้ไขแล้ว',          cls: 'bg-yellow-500/20 text-yellow-700 dark:text-yellow-300 border border-yellow-500/40 dark:border-yellow-500/30' },

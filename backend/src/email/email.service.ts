      ...
      if (hasSpares) {
        ...
        sparePartsHtml = `
          <div style="margin-top: 24px;">
            ...
            <div style="padding: 14px 16px; background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 6px; color: #64748b; font-size: 13px; font-family: Tahoma, 'Segoe UI', Arial, sans-serif;">

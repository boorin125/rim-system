        ...
        for (let i = 0; i < dto.spareParts.length; i++) {
          ...
          await this.prisma.sparePart.create({
            data: {
              ...
              oldEquipmentId: originalSp.oldEquipmentId || null,
              newEquipmentId: originalSp.newEquipmentId || null,
              componentName: (transformedSp as any).componentName || null,
              oldComponentSerial: (transformedSp as any).oldComponentSerial || null,
              newComponentSerial: (transformedSp as any).newComponentSerial || null,
              parentEquipmentId: (transformedSp as any).parentEquipmentId || null,
              notes: (transformedSp as any).notes || originalSp.notes || null,
            },
          });
        }
      }
